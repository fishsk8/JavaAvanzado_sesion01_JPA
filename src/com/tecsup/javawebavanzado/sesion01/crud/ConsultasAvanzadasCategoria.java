...
public class ConsultasAvanzadasCategoria {
	...
	public static void main(String[] args) {
		...
		try {
			...
			List<com.tecsup.javawebavanzado.sesion01.jpa.Categoria> listEmpOrder = (List<Categoria>) qOrder.getResultList();

			for (com.tecsup.javawebavanzado.sesion01.jpa.Categoria emp : listEmpOrder) {
